      ...
      <main className="flex-1 flex flex-col">
        <header className="bg-white border-b px-6 py-3 flex items-center justify-between">
          <p className="text-sm text-gray-500">
            Surat Masuk / <span className="font-medium">Pratinjau Surat</span>
          </p>
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <span className="ml-4 text-gray-400">Halaman 1 dari 1</span>
          </div>
        </header>
          ...
          <Link
            href={
              searchParams.get("letterId")
                ? `/UPA/identitas-pemohon?letterId=${searchParams.get("letterId")}`
                : "/UPA/identitas-pemohon"
            }
